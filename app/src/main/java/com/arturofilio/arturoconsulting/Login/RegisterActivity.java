...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void init() {
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checksInputs(email, username, password)) {
    ...
    private boolean checksInputs(String email, String username, String password) {
        Log.d(TAG, "checksInputs: checking inputs for null values");
                ...
                if (user != null) {
                    ...
                    myRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Toast.makeText(mContext, "Signup Succesfull. Sending verificaiton email", Toast.LENGTH_SHORT).show();
