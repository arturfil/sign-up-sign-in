...
public class CustomListAdapter  extends ArrayAdapter<Exercise> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String imgUrl = getItem(position).getImage_id();
        ...
        try{
            ...
            if(convertView == null){
                ...
                holder.title = (TextView) convertView.findViewById(R.id.exercise_name);
                holder.image = (ImageView) convertView.findViewById(R.id.exercise_image);
